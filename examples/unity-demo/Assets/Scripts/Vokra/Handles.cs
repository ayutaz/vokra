// Handles.cs — SafeHandle wrappers for the opaque C ABI handles (M0-10-T04).
//
...
// and guards against double-free / leaks. Demo code only ever sees the high-level
// VokraSession / VokraStream (T04) — a raw IntPtr never escapes this layer.
