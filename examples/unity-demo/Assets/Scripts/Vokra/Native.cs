// Native.cs — small marshalling helpers shared by the Vokra wrappers (M0-10-T03/T04).
...
namespace Vokra
{
    internal static class Native
    {
        ...
        /// is a thread-local errno (FR-API-01). The demo satisfies this by making
        /// every C ABI call on a single worker thread (M0-10-T07).
        /// </summary>
