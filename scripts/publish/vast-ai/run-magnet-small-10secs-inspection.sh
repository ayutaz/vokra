#!/usr/bin/env bash
# VAST-only, no-upload MAGNeT Small inspection preflight.
...
die(){ echo "magnet-small-10secs: BLOCKED: $*" >&2; exit 2; }
...
log(){ echo "magnet-small-10secs: $*" >&2; }
