...
source_only(){
  ...
  # imports ESPnet/model code or requests a checkpoint.  A blocked audit is
  # expected and must stop before source, BPE, or model acquisition.
  ...
  die 'OWSM official reference blocked: dependency/license evidence collected; owner review is pending'
