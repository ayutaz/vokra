...
self_test() {
  ...
  for needle in "$SOURCE_REPOSITORY" "$SOURCE_REVISION" 'transformers_compatibility.py' 'PASS_COMPATIBLE' 'NO_UPLOAD' '--validate-evidence' 'HF_TOKEN' 'HUGGING_FACE_HUB_TOKEN' 'checkpoint_access' 'constructor_calls' 'PYTHONDONTWRITEBYTECODE'; do
