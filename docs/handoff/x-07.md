...
> wording is historical planning, not an issued tag or release. Do not treat
> this handoff as evidence that a release occurred.
...
3. **Decide first-publish timing and version**: publish on a release tag (CD
   ...
   workspace version is `0.2.0`. The owner must choose the release version and
