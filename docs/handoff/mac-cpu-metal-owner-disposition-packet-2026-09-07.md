...
| MOSS Audio 4B / 8B | `tools/parity/moss_audio/license_gate_manifest.json` | `50948bb28d02a01ad2e1f754052a6e1b8ff8b1bf9f90dd9c525a1c464de58001` | The exact-head no-checkpoint API smoke is green for both variants. Resolve source/model licenses, checkpoint index/shard identities and the remaining review rows; no model was loaded and real weights remain blocked. |
