...
| Qwen3-TTS four variants | `tools/parity/qwen3_tts/license_gate_manifest.json` | `44daa1a9191e73a615e3ca32134a66a3619704b125587784afb4186a42b4f989` | This scope supersedes `46662c9a...` after vulnerable Accelerate was removed and the unproved real-weight loader was changed to `BLOCKED_SECURITY_ADVISORY`. The exact-head no-checkpoint API smoke is green for all four variants. Resolve the remaining component/dependency owner reviews and either approve a separately proved safe loader or withhold real-weight execution; no model was loaded and publication remains `NO_UPLOAD`. |
