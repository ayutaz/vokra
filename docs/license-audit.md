...
| **Whisper large-v3** | MIT | 2026-07-07 | 2026-07-23 yousan | ☑ Commercial / ☐ Research-only / ☐ Rejected | 同上。HF card は `apache-2.0` 表記だが GitHub LICENSE と turbo は `mit` — どちらも permissive で結論不変 |
