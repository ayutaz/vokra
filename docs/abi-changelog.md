...
| backfill | `vokra.bicodec.*` | **7** keys — `upstream_revision`, `checkpoint_sha256`, `config_sha256`, `source_repository`, `source_revision`, `inspection_status`, `input_authenticated` | `string` (6) + `bool` (1) | persisted (inspection-only) | `crates/vokra-convert/src/models/bicodec.rs` writes the exact staged-identity and source fields for `SparkAudio/Spark-TTS-0.5B` (`UPSTREAM_HF_REVISION=642071559bfc6346c2359d19dcb6be3f9dd8a05d`, checkpoint SHA `e9940cd48d4446e4340ced82d234bf5618350dd9f5db900ebe47a4fdb03867ec`, config SHA `744f4093ae2381a2eb44ea8c4a5268a8d1e581498e9bf0808c034d1b076429be`, source `https://github.com/SparkAudio/Spark-TTS` at `2f1ea9082400547242641f5271b6f941c9f439d1`). The group is additive; identity/authentication mismatches fail closed and no generic codec route is implied. | working tree (2026-08-29) |
