#!/usr/bin/env python3
"""Bridge facebook/magnet-medium-30secs upstream bundle → flat safetensors.
...
3. **Dedupes shared-storage tensors** via a ``data_ptr → canonical
   ...
   family posture inherited from sibling small).
...
``crates/vokra-convert/src/models/magnet_medium_30secs.rs`` unchanged.
