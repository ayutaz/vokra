...
containing the **1 B parameter flow-matching DiT
...
work directory, syncing, or acquiring any model/source data. The
...
EXPECTED_BUNDLE = {
    "README.md": (6560, "ab790ac275d6035184dabfa467be8ec8aa08a762ee3610cf43a061db45a8f0a1"),
    "compression_state_dict.bin": (238776630, "c075ee7c5b13d50937d1e4f197f3e940c3f3b74207857cb0e1e17891010fdc6d"),
    "state_dict.bin": (3849817990, "e9f95857aa1e0906fb44017ca2e4e8205395599693d6e80e5c3b8b7fc16498ef"),
}
...
def _self_test_body(bundle: Path) -> int:
    ...
    print("melodyflow-t24-30secs prepare self-test: PASS")
    return 0
...
def _self_test() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="melodyflow-prepare-", dir=temporary_root) as directory:
