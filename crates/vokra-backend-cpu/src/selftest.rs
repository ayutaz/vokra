...
impl core::fmt::Display for SelftestReport {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        write!(
            f,
            "cpu selftest OK: active={} features(avx2={} fma={} avx512={}/{}/{}/{} vnni={} bf16={} avxvnni={} neon={} fp16={} dotprod={} i8mm={} nbf16={} rvv_v={} zvfh={}) checked={:?} max_abs_diff={:.3e} (atol {:.0e})",
            self.active_isa,
            self.features.avx2,
            self.features.fma,
...
pub fn selftest() -> Result<SelftestReport> {
    ...
    // BackendUnavailable before any real work runs.
...
fn server_tier_selftest(features: &CpuFeatures) -> Result<()> {
    ...
    // Dequant fusion bit-identity on the host's SIMD family (T12).
    let host_best = features.best_isa();
    if !matches!(
        host_best,
        IsaPath::Scalar | IsaPath::Rvv | IsaPath::WasmSimd128
    ) {
        let simd =
